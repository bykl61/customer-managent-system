...
public class IBSExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IBSDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IBSStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IBSDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IBSDateTimeConverter dateTimeConverter = new IBSStandardDateTimeConverter();

    public IBSExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IBSExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IBSMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IBSHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IBSExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IBSHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
