...
public class IBSKPSPublicSoap
{
    ...
    public IBSKPSPublicSoap(){}

    public IBSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IBSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IBSExtendedSoapSerializationEnvelope envelope= new IBSExtendedSoapSerializationEnvelope(IBSExtendedSoapSerializationEnvelope.VER11);
